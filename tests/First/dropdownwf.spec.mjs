...
await page.locator("//input[@name='taskName']").fill("Dropdown=B");
await page.locator("//p[text()='+ Add Condition']/ancestor::button").click();
await page.locator("//label[@for='Task']/following-sibling::div//button").click();
await page.locator("//div[@role='option']//span[text()='Intake Form']").click();
await page.locator("//label[@for='Question']/following-sibling::div//button").click();
...
await page.locator("//div[@role='option']//span[text()='is']").click();
await page.locator("//label[@for='Value']/following-sibling::form//button").click();
await page.locator("//div[@role='option']//span[text()='B']").click();
await page.locator("(//p[text()='Save'])[2]").click();
...
await page.locator("//input[@name='taskName']").fill("Dropdown=Others");
await page.locator("//p[text()='+ Add Condition']/ancestor::button").click();
await page.locator("//label[@for='Task']/following-sibling::div//button").click();
await page.locator("//div[@role='option']//span[text()='Intake Form']").click();
await page.locator("//label[@for='Question']/following-sibling::div//button").click();
...
await page.locator("//label[@for='Condition']/following-sibling::div//button").click();
await page.locator("//div[@role='option']//span[text()='is not']").click();
await page.locator("//label[@for='Value']/following-sibling::form//button").click();
await page.locator("//div[@role='option']//span[text()='A']").click();
...
await page.locator("//p[text()='+ Add Condition']/ancestor::button").click();
await page.locator("(//label[@for='Task']/following-sibling::div//button)[2]").click();
await page.locator("//div[@role='option']//span[text()='Intake Form']").click();
await page.locator("(//label[@for='Question']/following-sibling::div//button)[2]").click();
await page.locator("(//div[@role='option'])[1]").click();

await page.locator("(//label[@for='Condition']/following-sibling::div//button)[2]").click();
await page.locator("//div[@role='option']//span[text()='is not']").click();
await page.locator("(//label[@for='Value']/following-sibling::form//button)[2]").click();
await page.locator("//div[@role='option']//span[text()='B']").click();
await page.locator("(//p[text()='Save'])[2]").click();
...
fs.writeFileSync('datafordropdowncondition.json', JSON.stringify(Information, null, 2), 'utf-8');
