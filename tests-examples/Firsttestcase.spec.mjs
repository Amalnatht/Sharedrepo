...
class Taskquestionnaire {
  constructor(questionname , typeoftask, userrole) {
...
await page.locator('//input[@name="workflowName"]').pressSequentially(randomText);
...
await page.getByText('Save & Continue').click();
task1details = new Taskquestionnaire('shorttext', "completion" , "requester");
...
await page.getByPlaceholder('Enter task name').pressSequentially(generateRandomText(5));
...
// await page.locator('//p[text()="Long Text"]/ancestor::div[1]').dragTo(page.locator('//h3[text()="Section 1"]/ancestor::div[2]/following-sibling::div'));
...
await page.keyboard.insertText('checklist1');
await page.getByText('Save & Continue').click();
task2details = new Taskquestionnaire('Longtext', "Approval", "csm");
...
await page.getByText('Add Section').click();
await page.keyboard.press('Enter');
await page.locator('//p[text()="Dropdown"]/ancestor::div[1]').dragTo(page.locator('//h3[text()="Section 1"]/ancestor::div[2]/following-sibling::div'));
...
await page.keyboard.insertText('checklist1');
await page.getByText('Save & Continue').click();
task3details = new Taskquestionnaire('Dropdown', "Approval", "csm");
...
export {Taskquestionnaire, task1details,task2details,task3details};